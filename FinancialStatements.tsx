...
export const FinancialStatements = ({ transactions, accounts, students, masterData, subTab }: any) => {
  ...
  if (reportType === "BGT") {
    ...
    content = (
      <div id="printable-area">
        <div style={{textAlign: 'center', marginBottom: '30px'}}><h2 style={{textTransform: 'uppercase'}}>Projected Revenue Dashboard</h2></div>
        ...
        <p style={{color: '#64748b', fontSize: '0.9rem', marginTop: '20px'}}>Note: Projected revenue is based on the Total Course Fee defined in students' profiles.</p>
      </div>
    );
  }
