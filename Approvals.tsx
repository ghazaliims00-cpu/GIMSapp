      ...
      <div>
         ...
         {editingTxn && (
            <div style={styles.modalOverlay}>
               <div style={{...styles.modalContent, width: '500px', borderRadius: '20px'}}>
               ...
               <table style={styles.table}>
                  <thead>
                     <tr style={{background: '#fafafa'}}>
                        <th style={{...styles.th, paddingLeft: '25px'}}>Date & Ref</th>
                        <th style={styles.th}>Entry Particulars</th>
                     ...
                     {displayed.map((t: any) => (
                        <tr key={t.id} style={{borderBottom: '1px solid #f1f5f9', transition: 'background 0.2s'}}>
                           <td style={{...styles.td, paddingLeft: '25px'}}>
                              ...
                              <div style={{fontSize: '0.75rem', color: '#94a3b8', fontFamily: 'monospace'}}>{t.voucherNo}</div>
                           </td>
                           <td style={styles.td}>
                              <div style={{fontWeight: 500}}>{t.description}</div>
                              <div style={{fontSize: '0.75rem', color: '#64748b', display: 'flex', gap: '8px', marginTop: '4px'}}>
                                 <span style={{background: '#f1f5f9', padding: '1px 5px', borderRadius: '4px'}}>Dr: {t.debitAccount}</span>
                                 <span style={{background: '#f1f5f9', padding: '1px 5px', borderRadius: '4px'}}>Cr: {t.creditAccount}</span>
                              </div>
                           </td>
                           <td style={{...styles.td, textAlign: 'right'}}>
                              <div style={{fontSize: '1.05rem', fontWeight: 800, color: '#0f172a'}}>Rs {t.amount.toLocaleString()}</div>
                           </td>
                           <td style={styles.td}>
                              <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
                                 ...
                                 <span style={{fontWeight: 500}}>{t.recordedBy}</span>
                              </div>
                           </td>
